...
BEGIN
	IF ( (SELECT COUNT(*) FROM absence a WHERE a.worker_id = worker_id) >= (SELECT whn.holiday_number_total FROM worker_holiday_number whn WHERE whn.worker_id = worker_id) ) THEN
